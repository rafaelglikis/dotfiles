...
3. Infer a short, descriptive kebab-case feature slug from the conversation or existing `.scratch` artifacts. If it cannot be inferred confidently, ask the user for the feature slug and wait for their answer. Write the spec using the template below, save it to `.scratch/<feature-slug>/spec.md`, and report the saved path to the user.
